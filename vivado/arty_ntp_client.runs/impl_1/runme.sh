...
HD_PWD='D:/FPGA/Xilinx/arty_ntp_client/vivado/arty_ntp_client.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_ntp_client.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_ntp_client.tcl -notrace
