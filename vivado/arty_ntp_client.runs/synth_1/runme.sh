...
HD_PWD='D:/FPGA/Xilinx/arty_ntp_client/vivado/arty_ntp_client.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_ntp_client.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_ntp_client.tcl
